...
window.onload = function()
{
	...
	SetfindLinkType( GetE('cmbfindLinkType').value ) ;
	...
	switch( GetE('cmbfindLinkType').value )
	{
		case 'url' :
			SelectField( 'txtUrl' ) ;
			break ;
...
function LoadSelection()
{
	...
	GetE('cmbfindLinkType').value = sType ;
}

//#### Link type selection.
function SetfindLinkType( linkType )
{
	ShowE('divfindLinkTypeUrl'		, (linkType == 'url') ) ;
	ShowE('divfindLinkTypeAnchor'	, (linkType == 'anchor') ) ;
	ShowE('divfindLinkTypeEMail'	, (linkType == 'email') ) ;
